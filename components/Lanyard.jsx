...
// Los assets se sirven desde public/lanyard/: evita configurar un cargador
// para .glb y mantiene el modelo fuera del bundle de JavaScript.
...
function Band({
  ...
  // La longitud del cordón no se toca: el ancho de la cinta está en
  // unidades de mundo, así que al acortar la cuerda la cinta se comía la
  // tarjeta. El encuadre se resuelve con la cámara, no con la física.
        ...
        >
          ...
          >
            <mesh geometry={nodes.card.geometry}>
              {/*
                Una tarjeta identificativa es plástico impreso, no metal.
                El componente venía con metalness 0.8, y un material metálico
                oscurece el color base: la foto salía apagada y gris. Con
                metalness casi a cero y el clearcoat puesto, la foto se ve
                como en el original y conserva el brillo del plastificado.
              */}
